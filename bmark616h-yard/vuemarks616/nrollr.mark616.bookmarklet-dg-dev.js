...
#@  
#@  
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   2023-04-02[Apr-Sun]07-50AM 


add title and url to bottom of body. 2023-04-02.


javascript:(function(){
var url = location.href; 
var title = document.title || url; 
var desc0=document.getSelection().toString(); 
var desc= desc0.concat("\n\n-----\n\n# ",title,"\n\n",url,"\n\n-----\n");  
    window.open(  'https://markg.daveg.win/markcreate/?url=%27 + encodeURIComponent(url)+  %27&title=%27 + encodeURIComponent(title)+%27&description=%27 + encodeURIComponent(desc)
  +%27&source=bookmarklet%27,%27_blank%27,%27menubar=no,height=800,width=600,toolbar=no,scrollbars=yes,status=no,dialog=1%27 ); } )();
...
#@  
#@  
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   2023-04-02[Apr-Sun]07-00AM 

in use 2023-04-02:

javascript:(        function(){          var url = location.href;          var title = document.title || url;          
var desc=document.getSelection().toString();          
window.open
(            'https://mark616g.198.144.183.160.nip.io/markcreate/?url=%27 + encodeURIComponent(url)+
            %27&title=%27 + encodeURIComponent(title)+            %27&description=%27 + encodeURIComponent(desc)+
            %27&source=bookmarklet%27,%27_blank%27,%27menubar=no,height=800,width=600,toolbar=no,scrollbars=yes,status=no,dialog=1%27
            );        }      )();
...
javascript: (function () {
    ...
    var desc = document.getSelection().toString();
    window.open('https://markg.daveg.win/markcreate/?url=%27 + encodeURIComponent(url)+
        % 27 & title=% 27
        + encodeURIComponent(title)
        +            % 27 & description=% 27
        + encodeURIComponent(desc)
        +            % 27 & source=bookmarklet % 27,%27_blank % 27,% 27menubar = no, height = 800, width = 600, 
                toolbar = no, scrollbars = yes, status = no, dialog = 1 % 27);
})();


one line:

javascript:(        function(){          var url = location.href;          var title = document.title || url;          var desc=document.getSelection().toString();          window.open(            'https://mark616g.198.144.183.160.nip.io/markcreate/?url=%27 + encodeURIComponent(url)+            %27&title=%27 + encodeURIComponent(title)+            %27&description=%27 + encodeURIComponent(desc)+            %27&source=bookmarklet%27,%27_blank%27,%27menubar=no,height=800,width=600,toolbar=no,scrollbars=yes,status=no,dialog=1%27          );        }      )();
